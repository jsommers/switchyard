...
class AddressTests(unittest.TestCase):
    ...
    def testUtils(self):
        ...
        self.assertEqual(infer_netmask(ip_address("10.0.0.1")), 8)
        self.assertEqual(infer_netmask(ip_address("192.168.1.24")), 24)
        self.assertEqual(infer_netmask(ip_address("149.43.80.25")), 16)
        self.assertEqual(infer_netmask(ip_address("0.0.0.0")), 0)
